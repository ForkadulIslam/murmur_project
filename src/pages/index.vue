  ...
  <div class="col-xs-12 col-sm-6 offset-sm-3 mt-5">
    <form @submit.prevent="submitForm">
      ...
      <div class="form-group max-auto">
        <button type="submit" class="btn myBtnColor w-100 mb-2">Login</button>
        <span style="font-size: 12px;">Don't have an account? </span>
        <nuxt-link to="/signup" style="font-size: 13px;">Create new</nuxt-link>
      </div>
...
import {setToken, getToken} from '~/helper/AuthHelper';
export default {
  data() {
    return {
      username: '',
